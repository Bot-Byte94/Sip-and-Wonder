...
export function CreatureArt({creature}:{creature:Creature}){
 const assetRoot=creature.stage===4&&creature.family!=='Sirenbean'?'/transparent-siplings':'/siplings';
 const assetId=creature.id==='cindervalkyr'?'cindervalkyr.trim':creature.id;
